  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-3xl animate-fade-in-up">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-heading font-bold leading-tight mb-4 text-gold-gradient">
          GRANO PROPERTIES
        </h1>
        <p className="text-xl md:text-2xl font-heading font-medium text-foreground mb-6">
